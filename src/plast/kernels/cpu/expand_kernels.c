#include "plast/kernels/cpu/expand_kernels.h"
...
void cpu_expand_kernel(const void* input_data, const size_t* input_shape,
                       ...
                       const size_t* output_shape, size_t output_ndim, size_t item_size)
{
    ...
    size_t effective_input_strides[input_ndim];
    ...
    for (size_t i = 0; i < total_output_elements; ++i)
    {
        ...
        size_t src_linear_index =
            calculate_linear_index(output_coords, effective_input_strides, input_ndim);
